...
const benefits = [
    {
        ...
        copy: 'Productos, lotes y alertas quedan listos desde el dashboard.'
    },
    {
        title: 'Caja clara',
        copy: 'Ventas y pagos del turno se revisan desde un solo flujo.'
    },
    {
    ...
    <main class="access-page">
        <div class="access-shell">
            <header class="access-header">
                ...
                <RouterLink class="ghost-button" to="/register">
                    Crear cuenta
                </RouterLink>
            </header>
